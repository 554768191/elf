package com.su.common.utils.qrcode;
...
public class QRCodeUtil {
    ...
    private static final String DEFAULT_PATH = "/tmp/yy";
    // 二维码尺寸
    ...
    public static String encode(String content, String imgPath, String destPath, boolean needCompress) throws Exception {
        ...
        if(destPath==null || destPath.trim().length()==0){
            destPath = DEFAULT_PATH;
        }

        destPath = destPath + File.separator + DateUtil.getDate() + File.separator;
        mkdirs(destPath);
        Random rnd = new Random();
        String file = rnd.nextInt(89999) + ".jpg";  //生成日期+随机数文件名
